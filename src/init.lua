...
Library.Translations = {
	th = {
		...
		["ImportJSON"] = "วาง JSON เพื่อนำเข้า",
		["ImportJSONDesc"] = "วางข้อมูลการตั้งค่าที่ Export ไว้",
		["ExportJSON"] = "คัดลอกการตั้งค่าเป็น JSON",
		["ImportJSONButton"] = "นำเข้าการตั้งค่าจาก JSON",
		["ExportFail"] = "Export JSON ล้มเหลว: %s",
		["ExportSuccess"] = "คัดลอก JSON ไปยังคลิปบอร์ดแล้ว",
		["ImportFail"] = "Import JSON ล้มเหลว: %s",
		["ImportSuccess"] = "นำเข้าการตั้งค่าจาก JSON แล้ว",
		["ClipboardUnavailable"] = "Executor นี้ไม่รองรับการคัดลอกไปยังคลิปบอร์ด",
		["TransferFile"] = "ชื่อไฟล์ JSON",
		["ExportCategories"] = "หมวดหมู่ที่ต้องการ",
		["ExportCategoriesDesc"] = "ไม่เลือกหมวดหมายถึงใช้ทั้งหมด",
		["ImportMode"] = "โหมดนำเข้า",
		["PreviewImport"] = "ดูก่อนนำเข้า",
		["PreviewResult"] = "จะเปลี่ยน %d ค่า และข้าม %d ค่า",
		["ApplyImport"] = "ยืนยันการนำเข้า",
		["CancelImport"] = "ยกเลิก",
		["ExportJSONFile"] = "Export เป็นไฟล์ JSON",
		["ImportJSONFile"] = "Import จากไฟล์ JSON",
		["ExportFileSuccess"] = "บันทึก JSON ที่ %s แล้ว",
		["ResetConfig"] = "คืนค่าเริ่มต้น",
		["ResetSuccess"] = "คืนค่าเริ่มต้นแล้ว %d ค่า",
		["Theme"] = "ธีมสีหน้าต่าง",
	...
	en = {
		...
		["ImportJSONDesc"] = "Paste a previously exported configuration.",
		["ExportJSON"] = "Copy configuration as JSON",
		["ImportJSONButton"] = "Import configuration from JSON",
		["ExportFail"] = "Failed to export JSON: %s",
		["ExportSuccess"] = "Copied configuration JSON to the clipboard.",
		["ImportFail"] = "Failed to import JSON: %s",
		["ImportSuccess"] = "Imported configuration from JSON.",
		["ClipboardUnavailable"] = "This executor does not support clipboard copying.",
		["TransferFile"] = "JSON file name",
		["ExportCategories"] = "Categories",
		["ExportCategoriesDesc"] = "Leave empty to include every category.",
		["ImportMode"] = "Import mode",
		["PreviewImport"] = "Preview import",
		["PreviewResult"] = "%d values will change; %d values will be skipped.",
		["ApplyImport"] = "Apply import",
		["CancelImport"] = "Cancel",
		["ExportJSONFile"] = "Export to JSON file",
		["ImportJSONFile"] = "Import from JSON file",
		["ExportFileSuccess"] = "Saved JSON to %s.",
		["ResetConfig"] = "Reset to defaults",
		["ResetSuccess"] = "Reset %d values to defaults.",
		["Theme"] = "Theme",
		["Acrylic"] = "Acrylic",
